...
mod <- cmdstan_model("/gpfs/home/dw2625/r/BSIM/mvo_skepticalprior_trt.stan");
# 
# #---Data preprocess---#
...
### Data for stan model
x_main <- model.matrix( ~ factor(tr_rct_id) + factor(age) + factor(bl_sex) + factor(who_enroll) +
...
save(fit_sumry, file = paste0("/gpfs/home/dw2625/r/BSIM/", date_stamp, "/mvo_skepticalprior_trt_agecat.rda"))
