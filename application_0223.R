...
mod <- cmdstan_model("/gpfs/home/dw2625/r/BSIM/mvo.stan");
# 
# #---Data preprocess---#
...
studydata <- list(
  ...
  A=dind$bl_treatment, D=D, L=L,sigma_beta_star=sigma_beta_star)
#J: #outcome
#D: # of cov
#---model fitting---#
fit <- mod$sample(
...
save(fit_sumry, file = paste0("/gpfs/home/dw2625/r/BSIM/", date_stamp, "/fit_sumry_sigma_2_5",sigma_beta_star,".rda"))
